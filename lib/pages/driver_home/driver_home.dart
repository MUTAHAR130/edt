...
class _DriverHomeScreenState extends State<DriverHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final rides = snapshot.data?.docs.where((doc) {
      ...
      final rejectedDrivers = data['rejectedDrivers'] as List<dynamic>?;

      // Keep rides if `rejectedDrivers` does not exist or does not contain current driver
      return rejectedDrivers == null || !rejectedDrivers.contains(currentDriverId);
    }).toList();
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              ride['destinationAddress'] ?? 'No address',
                                              style: GoogleFonts.poppins(
                                                fontWeight: FontWeight.w400,
                                                fontSize: 12,
                                                color: Color(0xff000000)
                                        ...
                                        Expanded(
                                          child: GestureDetector(
                                            onTap: ()  {
                                              ...
                                              // print('TAPPEDD');
                                              Navigator.push(context, MaterialPageRoute(builder: (context)=>RideDetailsScreen(rideId:rideId)));
                                            },
                                            child: Container(
                                              height: 45,
                                              decoration: BoxDecoration(
